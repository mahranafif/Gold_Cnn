...
DATASET_DIR = Path("dataset/classifier")
OUTPUT_DIR = Path("models")
MODEL_PATH = OUTPUT_DIR / "gold_poster_classifier.pt"
...
def main():
    ...
    if len(train_ds.classes) != 2:
        raise RuntimeError(f"Expected 2 classes, found {train_ds.classes}")
            ...
            torch.save(
                {
                    ...
                    "task": "gold_poster_binary_classifier",
    ...
    metrics_path = OUTPUT_DIR / "gold_poster_classifier_metrics.json"
